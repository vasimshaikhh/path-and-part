...
const navigate = useNavigate();
  ...
  //     setPassval(true)
  //     console.log(passval,'PassValidation')
    ...
    if (isSuccess === true) {            
        ...
        if (iq === false) {
          ...
          navigate(0);
            ...
            localStorage.setItem('userName',data.details.f_name)
        } else {
        }
     } else {            
    }
            ...
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
              <TextField
                ...
                value={email || ''} onChange={(e) => {
                  ...
                  // ValiDo();
                  // validRegex.test(email) ? setEmailval(true) : setEmailval(false)
                }}
                autoFocus
              ...
              <TextField
                ...
                onChange={(e) => {
                  ...
                  // ValiDo();
                  // validRegexPassword.test(password) ? setPassval(true) : setPassval(false)
                }} 
                // helperText={password.length >=6 ? null : 'Password not Valid'}
                InputProps={{
              ...
              onClick={(e)=>{handleClick(e.preventDefault())}}
                ...
                variant="contained"
                sx={{ mt: 3, mb: 2 }}
                // disabled={emailval&&passval ? false : true}
              >
                Sign In
              </Button>
              <Grid container>
                ...
                <Link to="/rider/signin" variant="body2" style={{cursor:'pointer'}}>
                   Login as Rider
                  </Link>
                </Grid>
              </Grid>
