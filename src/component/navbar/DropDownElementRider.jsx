  ...
  transformOrigin={{
    ...
    horizontal: 'left',
        ...
        >
          ...
          {id !==null || undefined ? 
            <MenuItem sx={{ textTransform: 'capitalize', letterSpacing: '2px', color: 'black' }} onClick={() => { localStorage.removeItem('riderId'); navigate('/rider'); navigate(0) }}>logout</MenuItem>
                    :
                    <>
                ...
                {/* {pages?.map((page,i) => {
            return(
                <Link key={i} to={`/rider/${page}`} style={{textDecoration:'none'}}>
...
export default DropDownElementsRider